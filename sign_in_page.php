...
img{
    ...
    <div class="container">
        ...
        <div class="boxfront">
            ...
            <p>Password <span class="forget">Don't getting  Your password?</span></p>
            <input type="password" class="input2" name="password">
           <br/>
           <!-- <input type="submit" name="submit" value="submit"> -->
           <button class="btn1" type="submit" name="submit">Let's Begin</button> <br>
